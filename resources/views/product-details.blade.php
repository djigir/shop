        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6">
                <div class="single_product_desc">
                    ...
                    <h4 class="title"><a href="product-details.blade.php#">Long Yellow Dress</a></h4>
                    ...
                    <div class="widget size mb-50">
                        ...
                        <div class="widget-desc">
                            <ul>
                                <li><a href="product-details.blade.php#">32</a></li>
                                <li><a href="product-details.blade.php#">34</a></li>
                                <li><a href="product-details.blade.php#">36</a></li>
                                <li><a href="product-details.blade.php#">38</a></li>
                                <li><a href="product-details.blade.php#">40</a></li>
                                <li><a href="product-details.blade.php#">42</a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div id="accordion" role="tablist">
                        <div class="card">
                            <div class="card-header" role="tab" id="headingOne">
                                <h6 class="mb-0">
                                    <a data-toggle="collapse" href="product-details.blade.php#collapseOne"
                            ...
                            <div class="card-header" role="tab" id="headingTwo">
                                <h6 class="mb-0">
                                    <a class="collapsed" data-toggle="collapse"
                                       href="product-details.blade.php#collapseTwo" aria-expanded="false"
                        ...
                        <div class="card">
                            <div class="card-header" role="tab" id="headingThree">
                                <h6 class="mb-0">
                                    <a class="collapsed" data-toggle="collapse"
                                       href="product-details.blade.php#collapseThree" aria-expanded="false"
...
<!-- <<<<<<<<<<<<<<<<<<<< Single Product Details Area End >>>>>>>>>>>>>>>>>>>>>>>>> -->
    ...
    @include('product-details.related-products')
